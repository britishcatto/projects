#made it easier to modify, have fun kiddie
from pygame import *
...
win = font1.render('!!YOU WIN!!', True, (96, 240, 201))
lose = font1.render('!!YOU LOSE!!', True, (176, 70, 70))
...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet(img_bullet, self.rect.centerx-17, self.rect.top, 35, 50, -15)
        bullets.add(bullet)
#enemy sprite class 
    ...
    if not finish:
        ...
        if rel_time == True:
            ...
            if now_time - last_time < 2: #before 3 seconds are over, display reload message
                ...
                num_fire = -3   #set the bullets counter to zero
        ...
        if life == 3:
            life_color = (109, 247, 160)
        if life == 2:
            life_color = (10, 219, 87)
        if life == 1:
            life_color = (5, 97, 39)
